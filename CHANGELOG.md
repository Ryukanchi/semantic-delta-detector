...
- **Join Explanation Precision**: Describe LEFT-to-INNER join changes using the actual
  joined table instead of hard-coded users/orders wording, and describe the population
  exclusion effect more cautiously.
